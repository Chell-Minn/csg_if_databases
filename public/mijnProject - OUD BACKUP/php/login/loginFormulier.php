...
if ($_SESSION["user"]) {
    ...
    echo '<a href="php/login/logout.php"><button type="submit" class="btn btn-secondary mb-2">Logout</button></a>';

}
else {
?>

                <form method="POST" class="form-inline" action="php/login/login.php">
